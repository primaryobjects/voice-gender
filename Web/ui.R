  ...
  conditionalPanel(condition='!output.json',
   ...
   div(id="register-div",
     div(
       ...
       div(id="info",
         tags$i(class="fa fa-info-circle", style="float: left; margin: 2px 0 0 6px;", "data-toggle"="tooltip", "data-placement"="bottom", title="We need your help! This app uses a method of artificial intelligence, called machine learning, to determine the gender of a voice. Unfortunately, it's not cheap to host this thing, and the app will go down if we're unable to keep it hosted online. :( You can help by registering for the site to allow us to order a hosting plan!")
       )
     ),
